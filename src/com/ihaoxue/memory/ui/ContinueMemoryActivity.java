...
public class ContinueMemoryActivity extends BaseActivity implements OnClickListener {

	String question = "{"
			+ "\"questionId\": \"123\", \"questionContent\": "
			+ "\"你好____你是____，请问你是____?\",\"answerSum\": \"3\",\"questionArr\":"
			+ " [\"你好世界你是____，请问你是____?\", \"你好____你是中国，请问你是____?\", "
			+ " \"你好____你是____，请问你是哪里?\" ]" + "}";
	...
	public static String questionAll = "{"
			+ "\"questionId\": \"123\", \"questionContent\": " + "\"" + content
			+ "\",\"answerSum\": \"3\",\"questionArr\":" + " [\"" + question1
			+ "\", \"" + question2 + "\", " + " \"" + question3 + "\" ],"
	...
	protected void setMainContentView() {
		...
		MemoryApplication.getInstance().addActivity(ContinueMemoryActivity.this) ;
	}
	...
	protected void initEvent() {
		...
		mTestPagerAdapter = new ExamPagerAdapter(ContinueMemoryActivity.this,
				mWebViews);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.back:
			ContinueMemoryActivity.this.finish();
	...
	public void nextQuestion() {
		...
		if (currentIndex < questionIdArr.length) {
			...
			if (flagSum == 0) { // 表示所有的都学会了
				...
				intentSuccess.setClass(ContinueMemoryActivity.this,
				...
				intent.setClass(ContinueMemoryActivity.this,
						ExamNextMemoryActivity.class);
	...
	public View createItemView(int index) {
		if (index < questionArrFlag.length) {
			if (questionArrFlag[index] == 0) {
				View mView = LayoutInflater.from(ContinueMemoryActivity.this).inflate(
				...
				View mView = LayoutInflater.from(ContinueMemoryActivity.this).inflate(R.layout.view_item_memory_test, null) ;
				...
				if (mView != null) {
					...
					memoryViewHolder.smallImageUrl = "" ;
					memoryViewHolder.largeImageUrl = "" ;
	...
	public void JumShowImage(){
		...
		Intent intent = new Intent() ;
		intent.setClass(ContinueMemoryActivity.this, ImageViewShowActivity.class) ;
		startActivity(intent) ;
		
	}
	
	public void imageShow(ImageView imageView){
		ImageCacheManger.loadImage("http://a3.att.hudong.com/01/61/01200000032142134377613701370_s.jpg",
				imageView, getBitmapFromResources(ContinueMemoryActivity.this,R.drawable.ic_launcher), getBitmapFromResources(ContinueMemoryActivity.this,R.drawable.ic_launcher)) ;
	}
