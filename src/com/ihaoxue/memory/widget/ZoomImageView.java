...
public class ZoomImageView extends View {
	...
	private ImageViewEvent mImageViewEvent ;
	...
	public void setImageViewEvent( ImageViewEvent mImageViewEvent){
		this.mImageViewEvent = mImageViewEvent ;
	}
	/*
	 * 将待展示的图片设置进来。
	 * 
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			if (secClick-firClick<250) {
				mImageViewEvent.onImageViewListerner() ;
			}
			break;
...
//				float wi = width /sourceBitmap.getWidth() ;
//				float hi = height /sourceBitmap.getHeight() ;
//				
//				if (wi>hi) {
//					
//				}
