...
public class MainHomeProgressBar extends ProgressBar {
	private String text_progress;
	private Paint mPaint;//画笔

	public MainHomeProgressBar(Context context) {
		super(context);
		initPaint();
	}
	public MainHomeProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }
	public MainHomeProgressBar(Context context, AttributeSet attrs, int defStyle) {
